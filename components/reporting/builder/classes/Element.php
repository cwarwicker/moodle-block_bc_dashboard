...
abstract class Element {
    ...
    public static function retrieve($enabledOnly = true, $flatList = false){
        ...
        $return = array();
        $records = ($enabledOnly) ? $DB->get_records("block_bcdb_report_elements", array("enabled" => 1), "plugin, subplugin, name") : $DB->get_records("block_bcdb_report_elements", array(), "plugin, name");
