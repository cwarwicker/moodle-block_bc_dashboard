...
class SQLParameter {
    ...
    public function getElementValueName($num) {
        ...
        } else if ($this->type == 'user_picker') {

            $user = \bcdb_get_user_name($this->elementValue[$num]);
            return ($user) ? addslashes($user) : false;

        } else if ($this->type == 'block_gradetracker/qual_picker' && $bcdb['gradetracker']) {

            $qual = new \block_gradetracker\Qualification();
    ...
    public function getElementTypeAttribute() {
        ...
        if ($this->type == 'course_picker') {
            ...
            return 'user';
        } else if ($this->type == 'block_gradetracker/qual_picker') {
            return 'qual';
        }
    ...
    public static function load($params) {
        return new \block_bc_dashboard\SQLParameter($params->num, $params->name, $params->type, (isset($params->default)) ? $params->default : null, (isset($params->options)) ? $params->options : array());
    }
