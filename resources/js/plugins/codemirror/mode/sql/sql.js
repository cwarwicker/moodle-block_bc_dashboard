...
(function() {
  ...
  var sqlKeywords = "alter and as asc between by count create delete desc distinct drop from group having in inner insert into is join left like not on or order outer right select set table union update values where limit ";
